...
<div class="container mt-5">
        <form method="POST" action="{{ route('offer.store') }}">
                ...
                <div class="card shadow-lg p-4 rounded">
                        ...
                        <div class="mb-3">
                                <label for="tokens" class="form-label fw-bold">Cantidad de TokenSkills</label>
                                <input type="number" name="tokens" class="form-control" id="tokens" placeholder="TokenSkills" value="{{ old('tokens', $oferta->tokens) }}">
