                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input {{ $disabled }} type="text" name="surname"
                                        class="form-control @error('surname') is-invalid @enderror" id="surname"
                                        value="{{ old('surname', $user->surname) }}" placeholder="Apellidos">
                                    @error('surname')
                                        <div class="invalid-feedback">
                                            <i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input {{ $disabled }} type="text" name="username"
                                        ...
                                        value="{{ old('username', $user->username) }}" placeholder="Nombre de usuario">
                                    @error('username')
                                        <div class="invalid-feedback">
                                            <i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input {{ $disabled }} type="text" name="tokens"
                                        class="form-control @error('tokens') is-invalid @enderror" id="tokens"
                                        value="{{ old('tokens', $user->tokens) }}" placeholder="Tokens...">
                                    @error('tokens')
                                        <div class="invalid-feedback">
                                            <i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input {{ $disabled }} type="text" name="profile_pic"
                                        class="form-control @error('profile_pic') is-invalid @enderror" id="profile_pic"
